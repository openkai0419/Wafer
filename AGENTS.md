...
- When modifying Python file under `/wayfer`, create or update the matching test in `/tests/wayfer/`.
...
- Keep `/tests/wayfer/` directory matching the structure of `/wayfer/` for visibility.
