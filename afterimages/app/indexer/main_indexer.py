from afterimages.utils.paths import data_db_path, setting_db_path
...
from afterimages.core.db.db_utils import remove_orphan_databases, delete_database_files
