    ...
    def commands(cls):
        return [
            ...
            ActionKit.Command(
                ...
                params=[ActionKit.Param(name=k, value=True) for k in ORIENTATION_CHOICES] + [ActionKit.Param(name="reverse", value=False)],
            ),
            "-",
            ":Scale",
...
class GridViewDragCommands(ActionKit.DragMenuBase):
    ...
    def drag_files_start(ctx):
        ...
        def _run_drag():
            from source.core.actions.binding.mouse.mouseeventmanager import MouseStateManager
            try:
