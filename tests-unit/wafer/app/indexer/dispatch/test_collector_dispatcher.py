...
from wafer.app.indexer.dispatch.collector_dispatcher import CollectorDispatcher, _DISPATCH_INTERVAL
from wafer.plugin.collector.handler import collector_resolver


def test_compile():
    py_compile.compile("wafer/app/indexer/dispatch/collector_dispatcher.py")
