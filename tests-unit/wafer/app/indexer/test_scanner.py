...
def test_backfill_parsers_inserts_pending(tmp_path):
    ...
    db.conn.execute("INSERT INTO hash_index (file_hash) VALUES ('h1')")
    db.conn.execute("INSERT INTO sources (source, file_hash, size, modified) VALUES ('/a.jpg', 'h1', 100, 1.0)")
    db.conn.execute("INSERT INTO files (path, source, aspect_ratio) VALUES ('/a.jpg', '/a.jpg', 1.0)")
    db.conn.execute("INSERT INTO meta_info (path, key, value) VALUES ('/a.jpg', 'exif.comment', '{}')")
    db.conn.commit()
...
def test_backfill_parsers_skips_existing_status(tmp_path):
    ...
    db.conn.execute("INSERT INTO files (path, source, aspect_ratio) VALUES ('/a.jpg', '/a.jpg', 1.0)")
    db.conn.execute("INSERT INTO meta_info (path, key, value) VALUES ('/a.jpg', 'exif.comment', '{}')")
    db.conn.execute("INSERT INTO collection_status (source, collector, status, collected_at) VALUES ('/a.jpg', 'nai', 'ok', 1.0)")
    db.conn.commit()
