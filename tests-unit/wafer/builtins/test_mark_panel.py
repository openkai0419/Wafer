...
def test_mark_is_meta_panel_subclass():
    assert issubclass(MarkTagPanelPlugin, BaseKeyValuePanelPlugin)
    assert MarkTagPanelPlugin.PREFIX == "mark"
    assert MarkTagPanelPlugin.DATA_SCOPE == "*"
