...
from wafer.core.commands.binding.common import TEXT_ENTRY_TYPES, is_text_entry_focused
from wafer.core.commands.binding.key import shortcutmanager as sm_mod
from wafer.core.commands.binding.key.shortcutmanager import ShortcutManager
