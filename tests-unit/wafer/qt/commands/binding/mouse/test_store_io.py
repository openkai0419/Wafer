...
from wafer.qt.commands.binding.mouse.types import MouseActionKey
from wafer.qt.commands.command.payload import CommandPayload
from wafer.qt.commands.binding.presets import set_presets, get_mouse_preset, get_mouse_preset_path
...
def test_mouse_store_diff_saves_deletions(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("wafer.qt.commands.binding.presets.get_resource_path", lambda: tmp_path)
