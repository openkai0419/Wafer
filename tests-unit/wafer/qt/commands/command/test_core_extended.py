...
from wafer.qt.commands.command.state import CommandOptionStore, ActionGroupStateManager
...
class TestConvenienceFunctions:
    def test_register_and_resolve_drop_accept(self):
        from wafer.qt.commands.command.core import register_drop_accept, resolve_drop_accept
    ...
    def test_resolve_drop_accept_empty(self):
        from wafer.qt.commands.command.core import resolve_drop_accept
