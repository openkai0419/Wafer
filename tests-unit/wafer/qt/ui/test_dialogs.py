...
def test_file_conflict_dialog_parse_choice():
    from wafer.qt.ui.dialogs import FileConflictDialog
...
def test_drop_target_dialog_normalizes_candidates():
    from wafer.qt.ui.dialogs import DropTargetDialog
...
def test_confirm_dialog_disables_named_buttons(qtbot):
    from wafer.qt.ui.dialogs import ConfirmDialog
...
def test_compile():
    py_compile.compile("wafer/qt/ui/dialogs.py")
