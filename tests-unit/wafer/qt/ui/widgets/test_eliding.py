...
def test_compile():
    py_compile.compile("wafer/qt/ui/widgets/eliding.py")


class TestElidingLabel:
    def test_keeps_full_text_in_tooltip_and_small_minimum_hint(self, qtbot):
        from wafer.qt.ui.widgets.eliding import ElidingLabel
...
class TestElidingToolButton:
    def test_keeps_full_text_in_tooltip_and_small_minimum_hint(self, qtbot):
        from wafer.qt.ui.widgets.eliding import ElidingToolButton
