...
from wafer.utils.helpers import invoke, invoke_int, get_callable, to_int, try_invoke, try_cast, try_json_loads, widget_prop_bool
...
def test_compile():
    py_compile.compile("wafer/utils/helpers.py")
