...
from afterimages.app.indexer.dispatcher import CollectorDispatcher, _BATCH_SIZE, _DISPATCH_INTERVAL


def test_compile():
    py_compile.compile('afterimages/app/indexer/dispatcher.py')
