...
from afterimages.app.viewer.grid.loader import ImageLoaderRunnable
from afterimages.app.viewer.grid.cachemanager import fullsize_key


def test_compile():
    py_compile.compile('afterimages/app/viewer/grid/loader.py')
...
class TestCacheHitWithSufficientSize:
    def test_cache_hit_when_cached_larger(self):
        ...
        with patch("afterimages.app.viewer.grid.loader.grid_resolver") as mock_gh:
