...
from afterimages.core.ipc.transport import NODE_TIMEOUT, Priority
from afterimages.core.ipc.broker import Broker, _CoalescingQueue, _PeerInfo
from afterimages.core.ipc.message import Message
from afterimages.core.ipc.node import Node


def test_compile():
    py_compile.compile('afterimages/core/ipc/message.py')
    py_compile.compile('afterimages/core/ipc/broker.py')
    py_compile.compile('afterimages/core/ipc/node.py')
    py_compile.compile('afterimages/core/ipc/transport.py')
    py_compile.compile('afterimages/core/ipc/outbox.py')
