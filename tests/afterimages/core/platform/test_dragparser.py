...
from afterimages.core.platform.dragparser import MimeDataParser, ParsedItem
from afterimages.core.platform.file_operations import FileSaver


def test_compile():
    py_compile.compile('afterimages/core/platform/dragparser.py')
