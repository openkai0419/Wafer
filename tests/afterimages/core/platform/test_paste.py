...
def test_compile():
    py_compile.compile('afterimages/core/platform/paste.py')
...
def test_execute_paste_plans_with_ui_exists():
    from afterimages.core.platform.paste import execute_paste_plans_with_ui
...
def test_clipboard_file_paster_importable():
    from afterimages.core.platform.paste import ClipboardFilePaster
