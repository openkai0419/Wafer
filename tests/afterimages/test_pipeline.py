...
from afterimages.utils.hashes import fast_signature_hash
from afterimages.core.db.file_db import FileDB
from afterimages.core.db.indexer import FileIndexer
from afterimages.plugin.collector.handler import collector_resolver
from afterimages.plugin.collector.base import CollectorResult
from afterimages.app.indexer.writer import CollectionWriter


def _get_exif_plugin():
    return collector_resolver.registry.get('exif')
from afterimages.app.indexer.progress_notifier import ProgressAggregator
