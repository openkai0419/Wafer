...
from source.image_viewer.search import SearchService, _DEFAULTS, SORT_CHOICES
from source.db.query import MetaQuery
...
def test_build_query_splittext():
    svc = _make_service()
    svc.set_param("splittext", ";")
    q = svc.build_query()
    assert q.splittext == ";"
