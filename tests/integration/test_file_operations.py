...
class TestFileExecutorCopy:
    def test_copy_single_file(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=0, src=src, is_dir=False, action="copy",
                          dst_default=dst, conflict=False, suggested_dst=None)
        ]
    ...
    def test_copy_directory(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=0, src=src_dir, is_dir=True, action="copy",
                          dst_default=dst_dir, conflict=False, suggested_dst=None)
        ]
        decisions = {0: PasteDecision(mode="overwrite")}
        executor = FileExecutor()
        results = executor.execute_plans(plans, decisions)
...
class TestFileExecutorCut:
    def test_cut_moves_file(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=0, src=src, is_dir=False, action="cut",
                          dst_default=dst, conflict=False, suggested_dst=None)
        ]
        decisions = {0: PasteDecision(mode="overwrite")}
        executor = FileExecutor()
...
class TestFileExecutorConflict:
    def test_skip_decision(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=0, src=src, is_dir=False, action="copy",
                          dst_default=dst, conflict=True, suggested_dst=None)
        ]
    ...
    def test_rename_decision(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=0, src=src, is_dir=False, action="copy",
                          dst_default=dst_dir / "a.txt", conflict=True, suggested_dst=None)
        ]
...
class TestFileExecutorMultiFile:
    def test_multiple_files(self, tmp_path):
        ...
        plans = [
            PastePlanItem(index=i, src=src, is_dir=False, action="copy",
                          dst_default=dst, conflict=False, suggested_dst=None)
