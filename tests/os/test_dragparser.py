...
from source.os.dragparser import MimeDataParser, ParsedItem
from source.os.save import FileSaver


def test_compile():
    py_compile.compile('source/os/dragparser.py')
...
def test_mimedata_parser_prefers_local_urls_over_filegroupdescriptor(qtbot, tmp_path):
    ...
    from source.os.dragparser import MimeDataParser
