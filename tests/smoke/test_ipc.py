    ...
    def test_broker_node_registration(self):
        ...
        try:
            ...
            try:
                ...
                assert _poll_until(lambda: broker.peer_counts().get("viewer", 0) >= 1)
            finally:
                node.stop()
        finally:
            broker.stop()
    ...
    def test_two_node_messaging(self):
        ...
        try:
            ...
            try:
                ...
                assert _poll_until(lambda: broker.peer_counts().get("viewer", 0) >= 1 and broker.peer_counts().get("indexer", 0) >= 1)
