...
from source.core.platform.dragparser import MimeDataParser, ParsedItem
from source.core.platform.file_operations import FileSaver


def test_compile():
    py_compile.compile('source/core/platform/dragparser.py')
