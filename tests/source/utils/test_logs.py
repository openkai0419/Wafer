...
class TestAppLogger:
    ...
    def test_error_with_exc(self):
        ...
        with patch("source.utils.logs._logger") as mock_logger:
...
class TestLoggerFactory:
    ...
    def _reset_factory(self):
        from source.utils.logs import _LoggerFactory
    ...
    def test_make_log_id_with_role(self):
        from source.utils.logs import _make_log_id
        import os
        pid = os.getpid()
    ...
    def test_set_role_renames_file_handler(self, tmp_path):
        import os
        import logging
        from source.utils.logs import _LoggerFactory, _make_log_id
        ...
        with patch('source.utils.logs._LOG_PATH', str(tmp_path)):
