...
def test_compile():
    py_compile.compile('wafer/app/viewer/commands/debug_commands.py')


class TestDebugCommands:
    @patch('wafer.constants.DEV_MODE', True)
    def test_register_in_dev_mode(self):
        from wafer.app.viewer.commands.debug_commands import DebugCommands
        DebugCommands.register()

    @patch('wafer.app.viewer.commands.debug_commands.DEV_MODE', False)
