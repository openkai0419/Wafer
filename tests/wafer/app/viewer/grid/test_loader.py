...
from wafer.app.viewer.grid.loader import ImageLoaderRunnable
from wafer.app.viewer.grid.cachemanager import fullsize_key


def test_compile():
    py_compile.compile('wafer/app/viewer/grid/loader.py')
...
class TestCacheHitWithSufficientSize:
    def test_cache_hit_when_cached_larger(self):
        ...
        with patch("wafer.app.viewer.grid.loader.grid_resolver") as mock_gh:
