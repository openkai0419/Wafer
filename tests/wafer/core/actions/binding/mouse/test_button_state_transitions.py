...
from wafer.core.actions.binding.mouse.types import (
    ClickType,
    MouseActionKey,
    MouseButton,
)
from wafer.core.actions.binding.mouse.manager import (
    MouseEventManager,
...
class TestModifiers:
    ...
    def test_ctrl_left_click(self, qtbot):
        from wafer.core.actions.binding.mouse.types import ModifierKey
