...
from wafer.core.actions.binding.mouse.types import MouseActionKey
from wafer.core.actions.command.payload import CommandPayload
from wafer.core.actions.binding.presets import set_presets, get_mouse_preset, get_mouse_preset_path
...
def test_mouse_store_diff_saves_deletions(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("wafer.core.actions.binding.presets.get_resource_path", lambda: tmp_path)
