...
def test_compile():
    py_compile.compile('wayfer/app/viewer/grid/grid_view.py')


class TestSelectionOverlay:
    @pytest.fixture(autouse=True)
    def _import(self, qtbot):
        from wayfer.app.viewer.grid.grid_view import _SelectionOverlay
...
class TestGridViewOverlayIntegration:
    ...
    def test_overlay_exists(self, qtbot):
        with patch('wayfer.app.viewer.grid.grid_view.grid_resolver'):
...
class TestEnsureWidgetVisible:
    ...
    @patch('wayfer.app.viewer.grid.grid_view.grid_resolver')
    @patch('wayfer.app.viewer.grid.grid_view.thread_pool')
    @patch('wayfer.app.viewer.grid.grid_view.ImageLoaderRunnable')
