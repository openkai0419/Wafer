...
from wayfer.app.viewer.grid.loader import ImageLoaderRunnable
from wayfer.app.viewer.grid.cachemanager import fullsize_key


def test_compile():
    py_compile.compile('wayfer/app/viewer/grid/loader.py')
...
class TestCacheHitWithSufficientSize:
    def test_cache_hit_when_cached_larger(self):
        ...
        with patch("wayfer.app.viewer.grid.loader.grid_resolver") as mock_gh:
