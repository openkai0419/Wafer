...
from wayfer.core.actions.command.core import (
    CommandBase,
    CommandMeta,
    CommandRegistry,
    register_command_defs,
)
from wayfer.core.actions.command.menu_builder import CommandMenuBuilder, MenuBuilder
from wayfer.core.actions.command.maker import MenuMaker
