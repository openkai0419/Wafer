...
from wayfer.core.platform.dragparser import MimeDataParser, ParsedItem
from wayfer.core.platform.file_operations import FileSaver


def test_compile():
    py_compile.compile('wayfer/core/platform/dragparser.py')
...
def test_mimedata_parser_prefers_local_urls_over_filegroupdescriptor(qtbot, tmp_path):
    ...
    from wayfer.core.platform.dragparser import MimeDataParser
