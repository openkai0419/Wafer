...
def test_paste_executor_overwrite_same_path_is_noop(tmp_path):
    from wayfer.core.platform.file_operations import PasteDecision, PasteExecutor, PastePlanItem
...
def test_scan_merge_conflicts_detects_files(tmp_path):
    from wayfer.core.platform.file_operations import scan_merge_conflicts
...
def test_paste_cancelled_error_importable():
    from wayfer.core.platform.file_operations import PasteCancelledError
