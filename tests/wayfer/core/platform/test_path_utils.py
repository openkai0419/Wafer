...
def test_check_copy_conflict_same_path(tmp_path):
    from wayfer.core.platform.path_utils import check_copy_conflict
...
def test_sanitize_filename_windows_invalid_chars():
    from wayfer.core.platform.path_utils import sanitize_filename
...
def test_unique_path_generates_increment(tmp_path):
    from wayfer.core.platform.path_utils import unique_path
...
def test_is_http_url():
    from wayfer.core.platform.path_utils import is_http_url
...
def test_get_os_new_folder_name():
    from wayfer.core.platform.path_utils import get_os_new_folder_name
