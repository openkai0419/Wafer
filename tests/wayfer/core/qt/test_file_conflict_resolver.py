...
def _make_plan(index, src, dst, is_dir=False, conflict=True, action="copy", suggested_dst=None):
    from wayfer.core.platform.file_operations import PastePlanItem
...
def test_file_apply_all_overwrite(monkeypatch, tmp_path):
    from wayfer.core.qt import file_conflict_resolver as r
...
def test_resolve_paste_plans_with_ui_empty():
    from wayfer.core.qt.file_conflict_resolver import resolve_paste_plans_with_ui
