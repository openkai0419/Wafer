...
from wayfer.plugin.collector.base import BaseCollectorPlugin
...
def test_compile_base():
    py_compile.compile('wayfer/plugin/collector/base.py')


def test_compile_handler():
    py_compile.compile('wayfer/plugin/collector/handler.py')
