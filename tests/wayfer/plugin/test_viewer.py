...
from wayfer.plugin.viewer.handler import viewer_resolver
from wayfer.plugin.viewer.base import BaseViewerPlugin, ImageViewerPlugin, WidgetViewerPlugin
...
def test_compile_base():
    py_compile.compile('wayfer/plugin/viewer/base.py')


def test_compile_handler():
    py_compile.compile('wayfer/plugin/viewer/handler.py')
...
def test_create_default_widget(qtbot):
    from wayfer.app.viewer.preview.image_viewer import ImageDisplayWidget
