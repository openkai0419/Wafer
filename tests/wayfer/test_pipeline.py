...
from wayfer.utils.hashes import fast_signature_hash
from wayfer.core.db.file_db import FileDB
from wayfer.core.db.indexer import FileIndexer
from wayfer.plugin.collector.handler import collector_resolver
from wayfer.plugin.collector.base import CollectorResult
from wayfer.app.indexer.writer import CollectionWriter


def _get_exif_plugin():
    return collector_resolver.registry.get('exif')
from wayfer.app.indexer.progress_notifier import ProgressAggregator
