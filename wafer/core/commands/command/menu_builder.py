...
class CommandMenuBuilder:
        ...
        *,
        ...
        for item in items:
            ...
            self._add_entry(
                ...
                command_id,
                meta,
                bool(meta.has_options) if (allow_options_with_selection or not selection_callback) else False,
                text_override,
                selection_callback,
    ...
    def _add_entry(
        ...
        container = self._create_row_widget(
            ...
            with_options,
            None,
            (lambda: self._show_options_and_close_menu(name, parent, menu, selection_callback if allow_options_with_selection else None)) if with_options else None,
            menu,
        )
    ...
    def _create_row_widget(
        ...
        icon: str | None,
        has_options: bool,
        on_main_click: Callable[[], None] | None,
    ...
    def _create_section_action(self, parent: QtWidgets.QWidget, text: str) -> QtWidgets.QAction:
        ...
        lbl.setStyleSheet(f"color: gray; font-size: {s}px;")
...
class MenuBuilder:
    ...
    def _build_into(self, names: list[str], selection_callback: Callable[[Any], None] | None, allow_options_with_selection: bool) -> QtWidgets.QMenu:
        if names:
            ...
            self._builder.build_into(
                self._menu, parent, names, display_map=None, selection_callback=selection_callback, allow_options_with_selection=allow_options_with_selection, seed_ctx=self._seed_ctx
            )
        return self._menu
