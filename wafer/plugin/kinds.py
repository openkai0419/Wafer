...
PLUGIN_KIND_GRID_OVERLAY = "grid_overlay"
...
PLUGIN_KIND_KEY_VALUE_PANEL = "key_value_panel"
PLUGIN_KIND_RENAME_SOURCE = "rename_source"
PLUGIN_KIND_IMAGE_LOADER = "imageloader"
PLUGIN_KIND_RESOLVER = "resolver"
PLUGIN_KIND_COMMAND = "command"

UNKNOWN_PLUGIN_KIND_COLOR = "#90a4ae"

PLUGIN_KINDS: dict[str, PluginKind] = {
    PLUGIN_KIND_PANEL: PluginKind(PLUGIN_KIND_PANEL, "Panel", "#FFF067"),
    PLUGIN_KIND_COMMAND: PluginKind(PLUGIN_KIND_COMMAND, "Command", "#FAB668"),
    PLUGIN_KIND_GRID: PluginKind(PLUGIN_KIND_GRID, "Grid", "#C99FFF"),
    PLUGIN_KIND_GRID_OVERLAY: PluginKind(PLUGIN_KIND_GRID_OVERLAY, "Overlay", "#D2B6FF"),
    PLUGIN_KIND_IMAGE_LOADER: PluginKind(PLUGIN_KIND_IMAGE_LOADER, "Loader", "#EC9FFF"),
    PLUGIN_KIND_RESOLVER: PluginKind(PLUGIN_KIND_RESOLVER, "Resolver", "#63FF85"),
    PLUGIN_KIND_VIEWER: PluginKind(PLUGIN_KIND_VIEWER, "Viewer", "#83FD83"),
    PLUGIN_KIND_KEY_VALUE_PANEL: PluginKind(PLUGIN_KIND_KEY_VALUE_PANEL, "Data", "#C6FFBA"),
    PLUGIN_KIND_COLLECTOR: PluginKind(PLUGIN_KIND_COLLECTOR, "Collector", "#78BEFF"),
    PLUGIN_KIND_PARSER: PluginKind(PLUGIN_KIND_PARSER, "Parser", "#9DFFF2"),
...
PRIORITY_PLUGIN_KIND_KEYS = frozenset((PLUGIN_KIND_GRID, PLUGIN_KIND_GRID_OVERLAY, PLUGIN_KIND_RESOLVER, PLUGIN_KIND_VIEWER))
