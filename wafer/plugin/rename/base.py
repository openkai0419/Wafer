...
def style_input(p):
    return f"background: {p.bg_primary}; color: {p.text_primary}; border: 1px solid {p.border_subtle}; border-radius: {dpix(3)}px; padding: {dpix(2)}px {dpix(4)}px; font-size: {dpix(11)}px;"
