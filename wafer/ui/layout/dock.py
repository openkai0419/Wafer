...
class PanelDockWidget(QtWidgets.QDockWidget):
    ...
    def __init__(self, name: str, parent: QtWidgets.QMainWindow | None = None, *, closable: bool = True):
        ...
        features = QtWidgets.QDockWidget.DockWidgetMovable | QtWidgets.QDockWidget.DockWidgetFloatable
        if closable:
            features |= QtWidgets.QDockWidget.DockWidgetClosable
        self.setFeatures(features)
        self.setAllowedAreas(QtCore.Qt.LeftDockWidgetArea | QtCore.Qt.RightDockWidgetArea | QtCore.Qt.TopDockWidgetArea | QtCore.Qt.BottomDockWidgetArea)
...
class FloatingWindow(QtWidgets.QWidget):
    ...
    def __init__(self, name: str, widget: QtWidgets.QWidget, parent: QtWidgets.QWidget | None = None):
        super().__init__(
            parent,
            QtCore.Qt.Window | QtCore.Qt.WindowCloseButtonHint | QtCore.Qt.WindowMinimizeButtonHint | QtCore.Qt.WindowMaximizeButtonHint,
        )
        self.panel_name = name
