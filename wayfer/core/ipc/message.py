...
class Message:
    __slots__ = ('topic', 'source', 'destination', 'db', 'payload', 'request_id', 'priority', 'coalesce')

    def __init__(self, topic: str, source: str, destination: str, db: str, payload: Any,
                 request_id: str | None, priority: int = Priority.MID, coalesce: bool = False):
        self.topic = topic
        self.source = source
